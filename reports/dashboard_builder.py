...
def build_trades_page(paper_trading_summary: dict) -> None:
    html_content = (
        ...
        '    var _wr = perf.win_rate     != null ? perf.win_rate.toFixed(1) + "%" : "\\u2014";'
        '    var _aw = perf.avg_win      != null ? (perf.avg_win > 0 ? "+" : "") + perf.avg_win.toFixed(2) + "%" : "\\u2014";'
        '    var _al = perf.avg_loss     != null ? perf.avg_loss.toFixed(2) + "%" : "\\u2014";'
        '    var _md = perf.max_drawdown != null ? perf.max_drawdown.toFixed(2) + "%" : "\\u2014";'
        '    var _tc = perf.total_closed != null ? perf.total_closed : "\\u2014";'
        ...
        '      + "<div class=\\"pt-perf-tile\\"><span class=\\"pt-perf-value\\">" + _tc + "</span><span class=\\"pt-perf-label\\">Closed Trades</span></div>"'
        '      + "<div class=\\"pt-perf-tile\\"><span class=\\"pt-perf-value\\">" + _wr + "</span><span class=\\"pt-perf-label\\">Win Rate</span></div>"'
        '      + "<div class=\\"pt-perf-tile\\"><span class=\\"pt-perf-value pt-pnl-pos\\">" + _aw + "</span><span class=\\"pt-perf-label\\">Avg Win</span></div>"'
        '      + "<div class=\\"pt-perf-tile\\"><span class=\\"pt-perf-value pt-pnl-neg\\">" + _al + "</span><span class=\\"pt-perf-label\\">Avg Loss</span></div>"'
        ...
        '      + "<div class=\\"pt-perf-tile\\"><span class=\\"pt-perf-value pt-pnl-neg\\">" + _md + "</span><span class=\\"pt-perf-label\\">Max Drawdown</span></div>"'
        '      + "</div></div>";'
        '  }'
