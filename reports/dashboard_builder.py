...
_INDEX_FETCH_JS = (
    ...
    "      var regimeCls = regimeRaw === 'low_vol' ? 'regime-calm' : regimeRaw === 'normal' ? 'regime-normal' : regimeRaw === 'elevated' ? 'regime-elevated' : regimeRaw === 'crisis' ? 'regime-crisis' : 'regime-normal';\n"
...
_ARCHIVE_FETCH_JS = (
    ...
    "        var regimeCls = regRaw === 'low_vol' ? 'regime-calm' : regRaw === 'normal' ? 'regime-normal' : regRaw === 'elevated' ? 'regime-elevated' : regRaw === 'crisis' ? 'regime-crisis' : 'regime-normal';\n"
